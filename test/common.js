...
export let alice, betty, elon, exampleNFTAdmin, exampleTokenAdmin, lostAndFoundAdmin, estimatorAdmin
...
export const setup = async () => {
    ...
    betty = await getAccountAddress("Betty")
    elon = await getAccountAddress("Elon")
...
export const before = async () => {
    ...
    await mintFlow(betty, 1.0)
    await mintFlow(elon, 1.0)
